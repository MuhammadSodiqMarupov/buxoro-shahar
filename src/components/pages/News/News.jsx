...
const News = ({
  ...
  const [HolographText, setHolographText] = useState([
    "Yangiliklar",
    "Йангиликлар",
    "Новости",
    "News",
  ...
  const handleChangePage = (data) => {
    ...
    headerAPI(
      "api/post/1?pageNumber=" + currentNumber,
      localStorage.getItem("langType") ?? "1"
    ).then(({ data }) => {
        ...
        <div className="content">
          ...
          <div className="content_news">
            ...
            >
              <div className="top">
                <img
                  className="main_item_image"
                  src={domen + myNews.imageUrl}
                  alt="Loading Image....."
                />
              </div>
              <div className="text">
              ...
              <div key={index} className="item_part">
                ...
                {item.second ? (
                  <div className="second" onClick={()=>{
                    ...
                    <div className="top">
                      <img
                        src={domen + item.second?.imageUrl}
                        className="item_image"
                        alt="Loading Image....."
                      />
                    </div>
