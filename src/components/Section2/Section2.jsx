...
const langData = [
    {
        ...
        txt6:" ☑️ 27-Jilvon saylov okrugidan Oliy Majlis Qonunchilik palatasiga deputat etib saylangan. ",
    ...
    },
    {
        ...
        txt6:" ☑️ 27-Жилвон сайлов округидан Олий Мажлис Қонунчилик палатасига депутат этиб сайланган. ",
    ...
    },
    {
         ...
         txt6: "☑️ Избран депутатом Законодательной палаты Олий Мажлиса от 27-го Джильванского избирательного округа. ",
    ...
    },
    {
         ...
         txt6:" ☑️ Elected as a deputy to the Legislative Chamber of the Oliy Majlis from the 27th Jilvan electoral district. ",
        ...
        <div className="Section2">
            <div className="S2Container">
                ...
                <div className="right_part">
                    ...
                    <button onClick={()=>navigate('/request')}><i className="fa-regular fa-envelope"></i> </button>
                </div>
            </div>
        </div>
    );
